...
- **Random Search vs Grid Search:** Random Search found slightly better parameters (values *between* the grid points) and ran faster (12.5s vs 18.2s).
- **Overfitting trade-off:** the tuned SVM is more accurate but overfits (train 0.945 / test 0.792, gap 0.153), while `min_samples_leaf=50` made the Decision Tree generalize cleanly (gap 0.019).
